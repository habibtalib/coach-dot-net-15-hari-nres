...
| **9.00 – 10.30 pagi** | **SESI 9: Teras C# & ASP.NET Core** — OOP, LINQ, `async/await`, DI; `dotnet new mvc`, `Program.cs`, middleware pipeline, corak Controller/View/ViewModel. 💻 Lab: projek berjalan |
| **10.30 – 1.00 tgh** | **SESI 10: EF Core & Entiti Kongsi** — `DbContext`, Data Annotations vs Fluent API, hubungan & kunci asing. 💻 Lab: entiti kongsi + `IEntityTypeConfiguration<T>` |
| 1.00 – 2.30 petang | Rehat & Makan Tengah Hari |
| **2.30 – 3.45 petang** | **SESI 11: Identity, RBAC & Servis Kongsi** — Identity, `[Authorize(Roles=...)]`, seed peranan; 6 servis kongsi; partial view + `SubmissionControllerBase`. 💻 Lab: asas kongsi lengkap |
| **3.45 – 5.00 petang** | **SESI 12: Seni Bina Anti-Konflik & Buka Cabang** — modul mendaftar diri, `ApplyConfigurationsFromAssembly`, `ModuleDescriptor`; migration `InitialShared`; gabung ke `master`; buka 4 cabang. 💻 Lab: migration + cabang |
