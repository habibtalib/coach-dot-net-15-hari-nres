...
| `IctSecurityOfficer` | Semak Akuan Pematuhan PKS |
| `IctAdmin` | Semak Pengurusan Kontrak, AD/email |
| `SecurityAdmin` | Semak pas, parkir, pelekat kenderaan |
| `FacilityAdmin` | Semak tempahan fasiliti sukan |
...
string[] roles = ["Applicant", "Supervisor", "HrAdmin", "IctSecurityOfficer", "IctAdmin", "SecurityAdmin", "FacilityAdmin", "SystemAdmin"];
...
- **Kumpulan 4** — `FacilityAdmin` menguruskan Tempahan Fasiliti Sukan dengan Authorization yang sama.
